...
class MapView: UIView {
    ...
    func setupButtonCurrentLocation(){
        ...
        buttonCurrentLocation.setBackgroundImage(UIImage(systemName: "mappin.and.ellipse"), for: .normal)
    ...
    func setupButtonSearch(){
        ...
        //buttonSearch.titleLabel?.textAlignment = .center
        //buttonSearch.titleLabel?.font = UIFont(name: titleFont, size: 20)
        //buttonSearch.setBackgroundImage(UIImage(systemName: "magnifyingglass.circle.fill"), for: .normal)
        buttonSearch.setBackgroundImage(UIImage(systemName: "pawprint"), for: .normal)
        //buttonSearch.layer.backgroundColor = UIColor.darkGray.cgColor
        buttonSearch.tintColor = .systemBrown
        buttonSearch.layer.cornerRadius = 10
        
        buttonSearch.layer.shadowOffset = .zero
        buttonSearch.layer.shadowRadius = 5
    ...
    func initConstraints(){
        NSLayoutConstraint.activate([
            ...
            buttonSearch.heightAnchor.constraint(equalToConstant: 100),
            buttonSearch.widthAnchor.constraint(equalToConstant: 120)
        ])
    }
