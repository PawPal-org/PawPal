...
class SearchBottomSheet: UIView {
    ...
    func setupSearchBar(){
        ...
        searchBar.searchTextField.font = UIFont(name:lightFont, size: 16)
    ...
    func setupTableViewSearchResults(){
        ...
        tableViewSearchResults.register(SearchTableViewCell.self, forCellReuseIdentifier: MapConfigs.searchTableViewID)
